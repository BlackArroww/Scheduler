...
public class view_scheduler extends JFrame {
	...
	public view_scheduler() {
		...
		prozess_lbl.setBounds(10, 11, 172, 31);
		...
		apl_btn.setBounds(141, 11, 193, 31);
		...
		work_field = new JTextField();
		work_field.setColumns(10);
		work_field.setBounds(47, 378, 287, 43);
		scheduler.add(work_field);
		...
		scheduler_lbl.setBounds(874, 11, 172, 31);
		scheduler.add(scheduler_lbl);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(1036, 11, 193, 31);
